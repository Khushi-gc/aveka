document.addEventListener("DOMContentLoaded", () => {
    ...
    function initAnimations() {
        ...
        // Mobile: Reset all inline styles
        ...
        // Desktop: Create scroll animations
        mm.add("(min-width: 1000px)", () => {
            ScrollTrigger.create({
                ...
                onUpdate: (self) => {
                    ...
                    // ANIMATION 1: Header fade in (10% - 25%)
                    ...
                    // ANIMATION 2: Container width (0% - 25%)
                    if (progress <= 0.25) {
                    ...
                    // ANIMATION 3: Gap and border radius (35%)
